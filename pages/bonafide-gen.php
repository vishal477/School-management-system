                                    ...
                                    <tbody>
                                        ...
                                        while($res=$rs->fetch_object()){
                                           ...
                                           <tr class="odd gradeX">
                                              ...
                                              <td><a href="bonafide.php?erno=<?php echo htmlentities($res->erno); ?>">
                                                  <p class="fa fa-box"></p>Generate Bonafide</td>
                                                  <td><img src="images\<?php echo ($res->erno)?>" style = "height: 80px; width: 100px"></td>
